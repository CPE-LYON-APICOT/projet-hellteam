...
| Trop d'entités ralentissent voire font crasher le jeu                                                                   | Elevée     | Provoquer un nombre de projectiles/ennemis très élevé à la seconde / / faire durer le jeu trop longtemps pour X raison                                             | Supprimer le tire dès qu'ils sortent de l'écran                                                                      |
